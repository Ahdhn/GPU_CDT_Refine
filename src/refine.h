...
typedef struct PStatus
{
    ...
    __forceinline__ __host__ __device__ PStatus() : _status(0)
    {
    }

    __forceinline__ __device__ __host__ void setDeleted()
    {
        _status = (_status | (1 << 0));
    }

    __forceinline__ __device__ __host__ bool isDeleted() const
    {
        return (_status & (1 << 0)) > 0;
    }

    __forceinline__ __device__ __host__ void setSteiner()
    {
        _status = (_status | (1 << 1));
    }

    __forceinline__ __device__ __host__ bool isSteiner() const
    {
        return (_status & (1 << 1)) > 0;
    }

    __forceinline__ __device__ __host__ void setSegmentSplit()
    {
        _status = (_status | (1 << 2));
    }

    __forceinline__ __device__ __host__ void setTriangleSplit()
    {
        _status = (_status & ~(1 << 2));
    }

    __forceinline__ __device__ __host__ bool isSegmentSplit() const
    {
        return (_status & (1 << 2)) > 0;
    }

    __forceinline__ __device__ __host__ void setNew()
    {
        _status = (_status | (1 << 3));
    }

    __forceinline__ __device__ __host__ void setOld()
    {
        _status = (_status & ~(1 << 3));
    }

    __forceinline__ __device__ __host__ bool isNew()
    {
        return (_status & (1 << 3)) > 0;
    }

    __forceinline__ __device__ __host__ void setReduntant()
    {
        _status = (_status | (1 << 4));
    }

    __forceinline__ __device__ __host__ bool isReduntant() const
    {
        return (_status & (1 << 4)) > 0;
    }

    __forceinline__ __device__ __host__ void createNewSegmentSplit()
    {
        _status = 0;
    ...
    __forceinline__ __device__ __host__ void createNewTriangleSplit()
    {
        _status = 0;
...
typedef struct TStatus
{
    ...
    __forceinline__ __host__ __device__ TStatus(void)
    {
        _status = 0;
    }

    __forceinline__ __host__ __device__ TStatus(bool n, bool b, bool c)
    {
        _status = 0;
    ...
    __forceinline__ __host__ __device__ void setNull(bool n)
    {
        if (n)
            _status = _status & (~1);
        else
    ...
    __forceinline__ __host__ __device__ bool isNull() const
    {
        return (_status & 1) == 0;
    }
    ...
    __forceinline__ __host__ __device__ void setBad(bool bad)
    {
        _status = (_status & ~(1 << 1)) | (bad ? 1 : 0) << 1;
    }

    __forceinline__ __host__ __device__ bool isBad() const
    {
        return (_status & (1 << 1)) > 0;
    }

    __forceinline__ __host__ __device__ void setCheck(bool check)
    {
        _status = (_status & ~(1 << 2)) | (check ? 1 : 0) << 2;
    }

    __forceinline__ __host__ __device__ bool isCheck() const
    {
        return (_status & (1 << 2)) > 0;
    }

    __forceinline__ __host__ __device__ void setFlip(bool flip)
    {
        _status = (_status & ~(1 << 3)) | (flip ? 1 : 0) << 3;
    }

    __forceinline__ __host__ __device__ bool isFlip() const
    {
        return (_status & (1 << 3)) > 0;
    }

    __forceinline__ __host__ __device__ void setFlipOri(int ori)
    {
        _status = (_status & ~(15 << 4)) | (ori << 4);
    }

    __forceinline__ __host__ __device__ int getFlipOri() const
    {
...
typedef struct MyList
{
    ...
    __forceinline__ __host__ __device__ MyList(void)
    {
        size = 0;
    }

    __forceinline__ __host__ __device__ bool push(int v)
    {
        if (size == LS)
            return false;
        a[size] = v;
    ...
    __forceinline__ __host__ __device__ bool pop(void)
    {
        if (size == 0)
            return false;
        else
    ...
    __forceinline__ __host__ __device__ bool find(int v)
    {
        bool result = false;
    ...
    __forceinline__ __host__ __device__ int getSize(void)
    {
        return size;
    }

    __forceinline__ __host__ __device__ int getLast(void)
    {
        return a[size - 1];
    }
